    ...
    public partial class f_nhanvien : Form
    {
        ...
        private void button_Them_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection cnn = new SqlConnection(constr))
            {
                ...
                string sqlInsert = $@"
        INSERT INTO btlNhanVien (sMaNV, sTenNV, sCCCD, sDiaChi, iSDT, dNgaySinh, dNgayVaoLam, sTenDangNhap, sMatKhau) 
        ...
        private void button_TimKiem_Click(object sender, EventArgs e)
        {
            using (SqlConnection cnn = new SqlConnection(constr))
            {
                cnn.Open();
                string query = @"
                          select sMaNV , sTenNV , sCCCD , sDiaChi , iSDT , dNgaySinh , dNgayVaoLam
                          from btlNhanVien
                          where 1=1";
