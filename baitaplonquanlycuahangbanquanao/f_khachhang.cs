...
namespace baitaplonquanlycuahangbanquanao
{
    public partial class f_khachhang : Form
    {
        ...
        string constr = "Data Source=DESKTOP-N0GLJ1N\\NAU;Initial Catalog=quanlycuahangbanquanao;Integrated Security=True";
        ...
        private void button_Them_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection cnn = new SqlConnection(constr))
            {
                ...
                string sqlInsert = $@"
        INSERT INTO btlKhachHang (sMaKH, sTenKH, sDiaChi, iSDT, dNgaySinh, bGioiTinh) 
        ...
        SET 
            ...
            iSDT = '{textBox_iSDT.Text}', 
            bGioiTinh = N'{gioiTinh}'
        ...
        private void button_TimKiem_Click(object sender, EventArgs e)
        {
            using (SqlConnection cnn = new SqlConnection(constr))
            {
                cnn.Open();
                string query = @"
                          select sMaKH , sTenKH , dNgaySinh ,  sDiaChi , iSDT , bGioiTinh
                          from btlKhachHang
                          where 1=1";
                ...
                {
                    query += " AND bGioiTinh = @bGioiTinh ";
                    parameters.Add(new SqlParameter("@bGioiTinh", "Nam"));
                }
                else if (radioButton_Nu.Checked)
                {
                    query += " AND bGioiTinh = @bGioiTinh ";
                    parameters.Add(new SqlParameter("@bGioiTinh", "Nữ"));
                }
