...
namespace baitaplonquanlycuahangbanquanao
{
    ...
    {
        public string connectionString = "Data Source=DESKTOP-N0GLJ1N\\DAT;Initial Catalog=BTL_HSK;Integrated Security=True";
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            //// Kiểm tra sản phẩm đã có trong dgvhangnhap chưa
            //foreach (DataGridViewRow row in dgvhangnhap.Rows)
            //{
            //    if (row.Cells["sMaMH"].Value?.ToString() == maMH)
            //    {
            //        // Nếu trùng mã mặt hàng, cập nhật số lượng và thành tiền
            ...
            //if (!daTonTai)
            //{
            //    dgvhangnhap.Rows.Add(maHDN, txbtennguoinhap, maNCC, ngayNhap.ToString("yyyy-MM-dd"), maMH, tenMH, tenLoaiHang, kichThuoc, mauSac, chatLieu, giaNhap, soLuong, soLuong * giaNhap);
            //}
