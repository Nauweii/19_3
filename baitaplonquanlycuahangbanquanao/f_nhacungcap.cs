...
namespace baitaplonquanlycuahangbanquanao
{
    public partial class f_nhacungcap : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = $"INSERT INTO btlNhaCungCap (sMaNCC, sTenNCC, sDiaChi, iSoDT, sEmail) VALUES " +
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string sql = $"UPDATE btlNhaCungCap SET sTenNCC = N'{tenNCC}', sDiaChi = N'{diaChi}', iSoDT = '{soDT}', sEmail = '{email}' " +
                         $"WHERE sMaNCC = '{maNCC}'";
